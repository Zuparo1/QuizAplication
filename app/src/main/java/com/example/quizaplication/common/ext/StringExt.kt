...
fun String.isValidUsername(): Int {
    return if (this.isBlank()) {
        ...
        3 //Username cannot contain a newline error
    } else if (this.length > MAX_USERNAME_LENGTH) {
        4 //Username cannot contain more than 18 characters error
    } else if (this.length < MIN_USERNAME_LENGTH) {
        5 //Username must contain 4 characters or more error
    } else {
        0 //Username is valid
    }
}
...
fun String.isValidPassword(): Int {
    ...
    } else if (this.length < MIN_PASSWORD_LENGTH) {
        3 //Password is too short error
    } else if (this.length > MAX_PASSWORD_LENGTH) {
